...
export const STR = {
  'zh-Hant': {
    ...
    rewindAll: '⏪ 倒退5秒', fastForwardAll: '⏩ 快進5秒',
    ...
    startAllTip: '開始/暫停全部（快捷鍵：空白鍵）', loopAllTip: '循環全部', resetAllTip: '重設全部（快捷鍵：Delete/Backspace）', delGroupTip: '刪除群組',
    rewindAllTip: '全部計時器倒退5秒（快捷鍵：←）', fastForwardAllTip: '全部計時器快進5秒（快捷鍵：→）',
  ...
  'zh-Hans': {
    ...
    rewindAll: '⏪ 倒退5秒', fastForwardAll: '⏩ 快进5秒',
    ...
    startAllTip: '开始/暂停全部（快捷键：空格键）', loopAllTip: '循环全部', resetAllTip: '重设全部（快捷键：Delete/Backspace）', delGroupTip: '删除群组',
    rewindAllTip: '全部计时器倒退5秒（快捷键：←）', fastForwardAllTip: '全部计时器快进5秒（快捷键：→）',
  ...
  'en': {
    ...
    rewindAll: '⏪ Rewind 5s', fastForwardAll: '⏩ Fast-Forward 5s',
    ...
    startAllTip: 'Start/Pause All (Shortcut: Space)', loopAllTip: 'Loop All', resetAllTip: 'Reset All (Shortcut: Delete/Backspace)', delGroupTip: 'Delete Group',
    rewindAllTip: 'Rewind All Timers 5s (Shortcut: Left Arrow)', fastForwardAllTip: 'Fast-Forward All Timers 5s (Shortcut: Right Arrow)',
